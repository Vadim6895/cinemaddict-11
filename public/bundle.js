...
/* harmony import */ var _models_film_card_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/film-card.js */ "./src/models/film-card.js");
...
const checkStatus = (response) => {
  if (response.status >= _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["CODE_RESPONSE"].MIN && response.status < _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["CODE_RESPONSE"].MAX) {
    return response;
  } else {
...
class Api {
  ...
  getFilmCards() {
    ...
    .then(_models_film_card_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilmCards);
  }
  ...
  getFullFilmCard(filmCard, indexCard) {
    ...
    .then((response) => response.json())
    .then((response) => {
      filmCard.comments = _models_comment_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments(response);
      return filmCard;
    });
  }
  ...
  addCommentCard(id, data) {
    ...
    return fetch(`https://11.ecmascript.pages.academy/cinemaddict/comments/${id}`, {
      ...
      .then((response) => response.json())
      .then((response) => {
        const filmCard = _models_film_card_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilmCard(response.movie);
        filmCard.comments = _models_comment_js__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments(response.comments);
        return filmCard;
      });
  }
  ...
  updateFilmCard(id, data) {
    ...
    return fetch(`https://11.ecmascript.pages.academy/cinemaddict/movies/${id}`, {
      ...
      .then(checkStatus)
      .then((response) => response.json())
      .then(_models_film_card_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilmCard);
  }
}
...
const createComentTemplate = (commentData, buttonData) => {
  const formatEmoji = () => {
    ...
    `<li class="film-details__comment">
      ...
      <div>
        ...
        <p class="film-details__comment-info">
          ...
          <span class="film-details__comment-day">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_1__["formatCommentDate"])(commentData.commentDate)}</span>
...
class Comment extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(commentData) {
    super();
    this.commentData = commentData;
    this.textDataButton = _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["DeletingBtnText"].DELETE;
  ...
  setDeletingBtn() {
    this.textDataButton = _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["DeletingBtnText"].DELETING;
    this.rerender();
    this.getElement()
...
const createFilmCardTemplate = (filmCardData) => {
  ...
  return (
    `<article class="film-card">
      ...
      <p class="film-card__description">${Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getFormatDescription"])(description)}</p>
      <a class="film-card__comments">${commentsNumber} comments</a>
      <form class="film-card__controls">
        <button class="film-card__controls-item button film-card__controls-item--add-to-watchlist ${filmCardData.isWatchlist ? _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_BTN_CLASS"] : ``}">Add to watchlist</button>
        <button class="film-card__controls-item button film-card__controls-item--mark-as-watched ${filmCardData.isAlreadyWatched ? _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_BTN_CLASS"] : ``}">Mark as watched</button>
        <button class="film-card__controls-item button film-card__controls-item--favorite ${filmCardData.isFavorite ? _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_BTN_CLASS"] : ``}">Mark as favorite</button>
      </form>
    </article>`
  );
};

class FilmCard extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
...
/* harmony import */ var _models_comment_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../models/comment.js */ "./src/models/comment.js");
...
const createFilmDetails = (filmCardData, templatePictureSmile, commentText) => {
  ...
  const formatSmile = () => {
    if (!templatePictureSmile) {
      templatePictureSmile = _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_SMILE"];
    }
...
const parseFromData = (formData, activeSmile) => {
  const commentText = Object(he__WEBPACK_IMPORTED_MODULE_3__["encode"])(formData.get(`comment`));
  return new _models_comment_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
    "comment": commentText,
    "date": new Date().toISOString(),
    "emotion": activeSmile ? activeSmile : _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_SMILE"],
  });
};
...
class FilmDetails extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  ...
  _setSubmitForm() {
    ...
    .addEventListener(`keydown`, (evt) => {
      if (evt.ctrlKey && evt.key === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["Key"].ENTER) {
        this._submitHandler();
      }
    });
  }
...
const createFiltersTemplate = (filters, activeFilter) => {
  const createFilters = () => {
    ...
    filters.slice(1, filters.length).forEach((filter) => {
      html += `<a href="#${filter.name}" class="main-navigation__item ${filter.name === activeFilter ? _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_LINK_FILTER"] : ``}">${filter.name} <span class="main-navigation__item-count">${filter.count}</span></a>`;
    });
    return html;
  };
  ...
  return `<nav class="main-navigation">
        <div class="main-navigation__items">
          <a href="#all" class="main-navigation__item ${activeFilter === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL ? _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_LINK_FILTER"] : ``}">All movies</a>
          ${createFilters()}
        </div>
        <a href="#stats" class="main-navigation__additional ${activeFilter === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FILTER_STATS"] ? _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_LINK_FILTER"] : ``}">Stats</a>
      </nav>`;
};


class Filter extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(filters, activeFilter = _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL) {
    super();
  ...
  setClickFiltersHandler(handler) {
    ...
    .addEventListener(`click`, (evt) => {
      if (evt.target.tagName === `A`) {
        const filterName = evt.target.href.substring(_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["PREFIX_HREF"].length);
    ...
    .addEventListener(`click`, () => {
      const filterName = _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FILTER_STATS"];
      this._activeFilter = filterName;
      this.rerender();
    });
  }
  ...
  setChange(handler) {
    ...
    .addEventListener(`click`, (evt) => {
      if (evt.target.tagName === `A`) {
        const menuItem = evt.target.href.substring(_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["PREFIX_HREF"].length);
        handler(menuItem);
      }
    });
  }
...
const createSortTemplate = (sortType) => {
  return (
    `<ul class="sort">
      <li><a href="#" data-sort-type="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}" class="sort__button sort__button--default ${sortType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT ? _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_SORT_BTN_CLASS"] : ``}">Sort by default</a></li>
      <li><a href="#" data-sort-type="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE}" class="sort__button sort__button--date ${sortType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE ? _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_SORT_BTN_CLASS"] : ``}">Sort by date</a></li>
      <li><a href="#" data-sort-type="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].RATING}" class="sort__button sort__button--rating ${sortType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].RATING ? _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["ACTIVE_SORT_BTN_CLASS"] : ``}">Sort by rating</a></li>
    </ul>`
  );
};
...
class Filters extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    this._handler = null;
    this._activeSortType = _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT;
  }
...
/*!***********************************************!*\
  !*** ./src/components/statistics-template.js ***!
  \***********************************************/
/*! exports provided: createStatisticsTemplate, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const renderChart = (statisticElement, filmCards) => {
  ...
  statisticCtx.height = _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["BAR_HEIGHT"] * _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["QUANTITY_BAR_HEIGHT"];
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(statisticCtx, {
    ...
    data: {
      ...
      datasets: [{
        data: [Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getGenreData"])(filmCards).SCI_FI, Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getGenreData"])(filmCards).ANIMATION, Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getGenreData"])(filmCards).FANTASY, Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getGenreData"])(filmCards).COMEDY, Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getGenreData"])(filmCards).TV_SERIES],
    ...
    options: {
      plugins: {
        datalabels: {
          font: {
            size: _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["CHART_OPTIONS"].SIZE
          },
          color: `#ffffff`,
          anchor: `start`,
          align: `start`,
          offset: _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["CHART_OPTIONS"].OFFSET,
        }
      },
      scales: {
        yAxes: [{
          ticks: {
            fontColor: `#ffffff`,
            padding: _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["CHART_OPTIONS"].PADDING,
            fontSize: _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["CHART_OPTIONS"].FONTSIZE
          },
          gridLines: {
            display: false,
            drawBorder: false
          },
          barThickness: _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["CHART_OPTIONS"].BARTHICKNESS
        }],
        xAxes: [{
          ticks: {
            display: false,
...
const createStatisticsTemplate = (actuallyFilmCards, filmCards) => {
  return (
    `<section class="statistic">
        <p class="statistic__rank">
          Your rank
          <img class="statistic__img" src="images/bitmap@2x.png" alt="Avatar" width="35" height="35">
          <span class="statistic__rank-label">${Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getRangUser"])(filmCards)}</span>
        </p>
        ...
        <ul class="statistic__text-list">
          <li class="statistic__text-item">
            ...
            <p class="statistic__item-text">${Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getWatchedMovies"])(actuallyFilmCards).length} <span class="statistic__item-description">movies</span></p>
          </li>
          <li class="statistic__text-item">
            <h4 class="statistic__item-title">Total duration</h4>
            <p class="statistic__item-text">${Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getWatchedMoviesLength"])(actuallyFilmCards, `hours`)} <span class="statistic__item-description">h</span> ${Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getWatchedMoviesLength"])(actuallyFilmCards, `minutes`)} <span class="statistic__item-description">m</span></p>
          </li>
          <li class="statistic__text-item">
            <h4 class="statistic__item-title">Top genre</h4>
            <p class="statistic__item-text">${actuallyFilmCards.length ? Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getTopGenre"])(actuallyFilmCards) : ``}</p>
          </li>
        </ul>
...
class Statistics extends _abstract_smart_component_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(filmCards) {
    ...
    this._yesterday.setDate(this._nowDate.getDate() - _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["PERIOD_MAP"].TODAY);
    this._sevenDaysDate = new Date();
    this._sevenDaysDate.setDate(this._nowDate.getDate() - _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["PERIOD_MAP"].WEEK);
    this._thirtyDaysDate = new Date();
    this._thirtyDaysDate.setDate(this._nowDate.getDate() - _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["PERIOD_MAP"].MONTH);
    this._yearDate = new Date();
    this._yearDate.setDate(this._nowDate.getDate() - _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["PERIOD_MAP"].YEAR);
  }
  ...
  _setPeriodStatistic() {
    const actuallyStatistic = {
      [_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticsMenu"].ALL_TIME]: 0,
      [_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticsMenu"].TODAY]: this._yesterday,
      [_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticsMenu"].WEEK]: this._sevenDaysDate,
      [_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticsMenu"].MONTH]: this._thirtyDaysDate,
      [_utils_const_js__WEBPACK_IMPORTED_MODULE_1__["StatisticsMenu"].YEAR]: this._yearDate
    };
    ...
    .addEventListener(`click`, (evt) => {
      if (evt.target.closest(`INPUT`)) {
        ...
        this._actuallyCards = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_2__["getPeriodCards"])(this._filmCards, actuallyStatistic[evt.target.id], this._nowDate);
...
const createUserRankHeaderProfileTemplate = (filmCards) => {
  return (
    `<section class="header__profile profile">
      <p class="profile__rating">${Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["getRangUser"])(filmCards)}</p>
...
/* harmony import */ var _utils_filter_cards_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/filter-cards.js */ "./src/utils/filter-cards.js");
...
class FilterController {
  constructor(container, filmCardsModel) {
    ...
    this._activeFilterType = _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL;
  ...
  render() {
    ...
    const filters = Object.values(_utils_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"]).map((filterType) => {
      return {
        name: filterType,
        count: Object(_utils_filter_cards_js__WEBPACK_IMPORTED_MODULE_3__["getCardsByFilter"])(filmCardsAll, filterType).length,
      };
    });

    const oldComponent = this._filterComponent;
    this._filterComponent = new _components_filters_js__WEBPACK_IMPORTED_MODULE_1__["default"](filters, this._activeFilterType);
    ...
    if (oldComponent) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(container, this._filterComponent, _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
    }
  }
...
/* harmony import */ var _components_film_details_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/film-details.js */ "./src/components/film-details.js");
/* harmony import */ var _components_comment_template_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/comment-template.js */ "./src/components/comment-template.js");
/* harmony import */ var _components_film_card_template_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/film-card-template.js */ "./src/components/film-card-template.js");
...
/* harmony import */ var _models_film_card_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/film-card.js */ "./src/models/film-card.js");
/* harmony import */ var _models_comment_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../models/comment.js */ "./src/models/comment.js");
...
class MovieController {
  constructor(mainElement, filmCards, dataChangeHandler, viewChangeHandler) {
    ...
    this._currentSmile = _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["DEFAULT_SMILE"];
  ...
  setDefaultView() {
    if (this._mode === _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDIT) {
  ...
  render(place, filmCard) {
    ...
    this._filmCardComponent = new _components_film_card_template_js__WEBPACK_IMPORTED_MODULE_2__["default"](filmCard);
    this._filmDetailsComponent = new _components_film_details_js__WEBPACK_IMPORTED_MODULE_0__["default"](filmCard, this._currentSmile, this._currentCommentText);
    ...
    this._filmCardComponent.setFilmCardClickHandler((evt) => {
      if (evt.target.closest(`IMG`) || evt.target.closest(`A`) || evt.target.closest(`H3`)) {
        ...
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._mainElement, this._filmDetailsComponent, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);

        if (this._mode === _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDIT) {
          this._mode = _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].DEFAULT;
        }
        this._viewChangeHandler();
        this._mode = _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["Mode"].EDIT;
    ...
    if (filmCardComponent && filmDetailsComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._filmCardComponent, filmCardComponent);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._filmDetailsComponent, filmDetailsComponent);
      this._renderComments(filmCard);

    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(place, this._filmCardComponent, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
    }
  }

  shake() {
    this._filmDetailsComponent.getElement().style.animation = `shake ${_utils_const_js__WEBPACK_IMPORTED_MODULE_3__["SHAKE_ANIMATION_TIMEOUT"] / 1000}s`;
    setTimeout(() => {
      this._filmDetailsComponent.getElement().style.animation = ``;
    }, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["SHAKE_ANIMATION_TIMEOUT"]);
  }
  ...
  shakeComment() {
    this.commentComponent.getElement().style.animation = `shake ${_utils_const_js__WEBPACK_IMPORTED_MODULE_3__["SHAKE_ANIMATION_TIMEOUT"] / 1000}s`;
    setTimeout(() => {
  ...
  _addHandlersForComponent(filmCard) {
    this._filmDetailsComponent.setForm(() =>{
      ...
      comment = new _models_comment_js__WEBPACK_IMPORTED_MODULE_6__["default"](comment.commentToRAW());
    ...
    this._filmDetailsComponent.setBtnAddtoWatchlistHandler(() => {
      ...
      const newFilmCard = _models_film_card_js__WEBPACK_IMPORTED_MODULE_5__["default"].clone(filmCard);
  ...
  _renderComments(filmCard) {
    filmCard.comments.forEach((comment) => {
      const commentComponent = new _components_comment_template_js__WEBPACK_IMPORTED_MODULE_1__["default"](comment);
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._filmDetailsComponent.getCommentsList(), commentComponent, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
    });
  }

  _escKeyDown(evt) {
    const isEscKey = evt.key === _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["Key"].ESC;
...
/* harmony import */ var _components_show_more_btn_template_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/show-more-btn-template.js */ "./src/components/show-more-btn-template.js");
/* harmony import */ var _utils_const_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/const.js */ "./src/utils/const.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _movie_controller_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./movie-controller.js */ "./src/controllers/movie-controller.js");
...
const getSortFilmCards = (filmCards, sortType, start, end) => {
  ...
  switch (sortType) {
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["SortType"].DEFAULT:
      sortedCards = showingCards;
      break;

    case _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["SortType"].DATE:
      sortedCards = showingCards.sort((a, b) => b.productionDate - a.productionDate);
      break;

    case _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["SortType"].RATING:
      sortedCards = showingCards.sort((a, b) => b.rating - a.rating);
      break;

    case _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["SortType"].COMMENT:
...
const renderFilmCards = (containerForCards, container, actuallyCardsArr, _dataChangeHandler, _viewChangeHandler) => {
  return actuallyCardsArr.map((filmCard) => {
    const movieController = new _movie_controller_js__WEBPACK_IMPORTED_MODULE_5__["default"](container, actuallyCardsArr, _dataChangeHandler, _viewChangeHandler);
...
class PageController {
  constructor(filmCardsModel, mainElement, api) {
    ...
    this._showMoreBtn = new _components_show_more_btn_template_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    ...
    this._countShowingFilmCards = _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["CARDS_COUNT"];

    this._filmsElement = this._container._element;
  }

  render() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._mainElement, this._sortComponent, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._mainElement, this._container, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);

    this._renderShowMoreBtn();
    this._setSortTypeChange();

    this._newFilmCards = renderFilmCards(this._filmsListContainer, this._mainElement, this._filmCardsModel.getFilmCardsAll().slice(0, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["CARDS_COUNT"]), this._dataChangeHandler, this._viewChangeHandler);
  ...
  hide() {
    ...
    if (sort) {
      sort.classList.add(_utils_const_js__WEBPACK_IMPORTED_MODULE_3__["HIDDEN_CLASS"]);
    }
    this._filmsElement.classList.add(_utils_const_js__WEBPACK_IMPORTED_MODULE_3__["HIDDEN_CLASS"]);
  }

  show() {
    this._setHandSortChange(_utils_const_js__WEBPACK_IMPORTED_MODULE_3__["SortType"].DEFAULT);
    const sort = document.querySelector(`.sort`);
    sort.classList.remove(_utils_const_js__WEBPACK_IMPORTED_MODULE_3__["HIDDEN_CLASS"]);
    this._filmsElement.classList.remove(_utils_const_js__WEBPACK_IMPORTED_MODULE_3__["HIDDEN_CLASS"]);
  }
  ...
  _updateFilmCards(count) {
    ...
    if (this._countShowingFilmCards >= this._filmCardsModel.getFilmCards().length) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._showMoreBtn);
    }
  }

  _filterChangeHandler() {
    this._updateFilmCards(_utils_const_js__WEBPACK_IMPORTED_MODULE_3__["CARDS_COUNT"]);
  }
  ...
  _renderShowMoreBtn() {
    ...
    if (this._filmCardsModel.getFilmCards().length <= _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["CARDS_COUNT"]) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._showMoreBtn);
    } else {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(filmsList, this._showMoreBtn, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
    }
    this._countShowingFilmCards = _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["CARDS_COUNT"];
    this._showMoreBtn.setShowMoreBtnClickHandler(() => {

      const prevFilmCards = this._countShowingFilmCards;
      this._countShowingFilmCards = this._countShowingFilmCards + _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["CARDS_COUNT"];
  ...
  _renderOtherContainers() {
    ...
    let sortCards = getSortFilmCards(this._filmCardsModel.getFilmCardsAll(), _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["SortType"].RATING, 0, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["CARDS_COUNT_FOR_OTHER"]);
    ...
    sortCards = getSortFilmCards(this._filmCardsModel.getFilmCardsAll(), _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["SortType"].COMMENT, 0, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["CARDS_COUNT_FOR_OTHER"]);
  ...
  _setSortTypeChange() {
    this._sortComponent.setSortTypeChangeHandler((sortType) => {
      ...
      const sortedFilmCards = getSortFilmCards(this._filmCardsModel.getFilmCards(), sortType, 0, _utils_const_js__WEBPACK_IMPORTED_MODULE_3__["CARDS_COUNT"]);
      this._removeFilmCards();
...
/* harmony import */ var _components_statistics_template_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/statistics-template.js */ "./src/components/statistics-template.js");
...
class StatisticController {
  ...
  render() {
    ...
    if (oldComponent) {
      this._statisticComponent = new _components_statistics_template_js__WEBPACK_IMPORTED_MODULE_0__["default"](this.actuallyCards);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._statisticComponent, oldComponent);
    } else {
      this._statisticComponent = new _components_statistics_template_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._filmCardsModel.getFilmCardsAll());
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._mainElement, this._statisticComponent, _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
    }
  }

  hide() {
    this._statisticComponent.getElement().classList.add(_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["HIDDEN_CLASS"]);
  }

  show() {
    this._statisticComponent.rerender();
    this._statisticComponent.getElement().classList.remove(_utils_const_js__WEBPACK_IMPORTED_MODULE_2__["HIDDEN_CLASS"]);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_user_rank_header_profile_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/user-rank-header-profile.js */ "./src/components/user-rank-header-profile.js");
...
/* harmony import */ var _components_footer_statistics_template_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/footer-statistics-template.js */ "./src/components/footer-statistics-template.js");
...
/* harmony import */ var _models_film_cards_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/film-cards.js */ "./src/models/film-cards.js");
...
const api = new _api_js__WEBPACK_IMPORTED_MODULE_8__["default"](_utils_const_js__WEBPACK_IMPORTED_MODULE_5__["AUTHORIZATION"]);
const filmCardsModel = new _models_film_cards_js__WEBPACK_IMPORTED_MODULE_6__["default"]();

const filterController = new _controllers_filter_controller_js__WEBPACK_IMPORTED_MODULE_1__["default"](mainElement, filmCardsModel);
filterController.render();

const pageController = new _controllers_page_controller_js__WEBPACK_IMPORTED_MODULE_3__["default"](filmCardsModel, mainElement, api);
const statisticController = new _controllers_statistic_controller_js__WEBPACK_IMPORTED_MODULE_7__["default"](filmCardsModel, mainElement);

mainElement.insertAdjacentHTML(_utils_const_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND, _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["LOADING"]);
...
.then((filmCards) => {
  ...
  .then(() => {
    ...
    if (filmCards.length) {
      const userRankProfile = new _components_user_rank_header_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](filmCardsModel);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(headerElement, userRankProfile, _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(footerStatistics, new _components_footer_statistics_template_js__WEBPACK_IMPORTED_MODULE_2__["default"](filmCardsModel.getFilmCardsAll()), _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND);

    } else {
      mainElement.insertAdjacentHTML(_utils_const_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND, _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["NO_FILMS"]);
    }
  });
})
.catch(() => {
  loading.remove();
  mainElement.insertAdjacentHTML(_utils_const_js__WEBPACK_IMPORTED_MODULE_5__["RenderPosition"].BEFOREEND, _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["LOADING_ERROR"]);
});

filterController.setChange((menuItem) => {
  switch (menuItem) {
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].ALL:
      statisticController.hide();
      pageController.show();
      break;
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].WATCHLIST:
      statisticController.hide();
      pageController.show();
      break;
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].HISTORY:
      statisticController.hide();
      pageController.show();
      break;
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].FAVORITES:
      statisticController.hide();
      pageController.show();
      break;
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["MenuItem"].STATISTICS:
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FilmCard; });
/* harmony import */ var _models_comment_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/comment.js */ "./src/models/comment.js");
...
class FilmCard {
  ...
  static clone(data) {
    const comments = data.comments.map((comment) => new _models_comment_js__WEBPACK_IMPORTED_MODULE_0__["default"](_models_comment_js__WEBPACK_IMPORTED_MODULE_0__["default"].clone(comment)));
...
/* harmony import */ var _utils_filter_cards_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/filter-cards.js */ "./src/utils/filter-cards.js");
/* harmony import */ var _utils_const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/const.js */ "./src/utils/const.js");
...
class FilmCards {
  constructor() {
    ...
    this._activeFilterType = _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL;
  }
  ...
  getFilmCards() {
    return Object(_utils_filter_cards_js__WEBPACK_IMPORTED_MODULE_0__["getCardsByFilter"])(this._filmCards, this._activeFilterType);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: formatCommentDate, formatShortDateMovie, formatFullDateMovie, formatTimeLengthMovie, getFormatDescription */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const formatCommentDate = (dateObj) => {
  return `${moment__WEBPACK_IMPORTED_MODULE_1___default()(dateObj).fromNow()}`;
};

const formatShortDateMovie = (dateObj) => {
  return `${moment__WEBPACK_IMPORTED_MODULE_1___default()(dateObj).format(`yyyy`)}`;
};

const formatFullDateMovie = (dateObj) => {
  return `${moment__WEBPACK_IMPORTED_MODULE_1___default()(dateObj).format(`d MMMM yyyy`)}`;
};
...
const getFormatDescription = (description) => {
  if (description.length >= _const_js__WEBPACK_IMPORTED_MODULE_0__["LENGTH_DESCRIPTION"].UNACCEPTABLE) {
    return description.split(``).slice(0, _const_js__WEBPACK_IMPORTED_MODULE_0__["LENGTH_DESCRIPTION"].ACCEPTABLE).join(``) + `...`;
  }
  return description;
};
...
/*!****************************!*\
  !*** ./src/utils/const.js ***!
  \****************************/
/*! exports provided: CARDS_COUNT, CARDS_COUNT_FOR_OTHER, ACTIVE_SORT_BTN_CLASS, FILTER_STATS, DEFAULT_SMILE, HIDDEN_CLASS, VALUE_HOUR, SHAKE_ANIMATION_TIMEOUT, BAR_HEIGHT, QUANTITY_BAR_HEIGHT, ACTIVE_BTN_CLASS, ACTIVE_LINK_FILTER, PREFIX_HREF, AUTHORIZATION, NO_FILMS, LOADING, LOADING_ERROR, CHART_OPTIONS, PERIOD_MAP, LENGTH_DESCRIPTION, RangMapWatchedMovies, CODE_RESPONSE, StatisticsMenu, GenreMap, RangMap, Key, RenderPosition, SortType, FilterType, Mode, MenuItem, DeletingBtnText */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CARDS_COUNT", function() { return CARDS_COUNT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CARDS_COUNT_FOR_OTHER", function() { return CARDS_COUNT_FOR_OTHER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ACTIVE_SORT_BTN_CLASS", function() { return ACTIVE_SORT_BTN_CLASS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FILTER_STATS", function() { return FILTER_STATS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DEFAULT_SMILE", function() { return DEFAULT_SMILE; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QUANTITY_BAR_HEIGHT", function() { return QUANTITY_BAR_HEIGHT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ACTIVE_BTN_CLASS", function() { return ACTIVE_BTN_CLASS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ACTIVE_LINK_FILTER", function() { return ACTIVE_LINK_FILTER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PREFIX_HREF", function() { return PREFIX_HREF; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AUTHORIZATION", function() { return AUTHORIZATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NO_FILMS", function() { return NO_FILMS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LOADING", function() { return LOADING; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LOADING_ERROR", function() { return LOADING_ERROR; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CHART_OPTIONS", function() { return CHART_OPTIONS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PERIOD_MAP", function() { return PERIOD_MAP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LENGTH_DESCRIPTION", function() { return LENGTH_DESCRIPTION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RangMapWatchedMovies", function() { return RangMapWatchedMovies; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CODE_RESPONSE", function() { return CODE_RESPONSE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatisticsMenu", function() { return StatisticsMenu; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GenreMap", function() { return GenreMap; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RangMap", function() { return RangMap; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DeletingBtnText", function() { return DeletingBtnText; });
const CARDS_COUNT = 5;
const CARDS_COUNT_FOR_OTHER = 2;
const ACTIVE_SORT_BTN_CLASS = `sort__button--active`;
const FILTER_STATS = `stats`;
const DEFAULT_SMILE = `smile`;
const HIDDEN_CLASS = `visually-hidden`;
const VALUE_HOUR = 60;
const SHAKE_ANIMATION_TIMEOUT = 600;
const BAR_HEIGHT = 50;
const QUANTITY_BAR_HEIGHT = 5;
const ACTIVE_BTN_CLASS = `film-card__controls-item--active`;
const ACTIVE_LINK_FILTER = `main-navigation__item--active`;
const PREFIX_HREF = `http://localhost:8080/#`;
...
const LOADING_ERROR = `<h2 class="films-list__title">Loading error</h2>`;
...
/***/ "./src/utils/filter-cards.js":
/*!***********************************!*\
  !*** ./src/utils/filter-cards.js ***!
  \***********************************/
/*! exports provided: getWatchListFilmCards, getHistoryFilmCards, getFavoritesFilmCards, getCardsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWatchListFilmCards", function() { return getWatchListFilmCards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getHistoryFilmCards", function() { return getHistoryFilmCards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFavoritesFilmCards", function() { return getFavoritesFilmCards; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getCardsByFilter", function() { return getCardsByFilter; });
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./const.js */ "./src/utils/const.js");



const getWatchListFilmCards = (filmCards) => {
  return filmCards.filter((filmCard) => filmCard.isWatchlist);
};

const getHistoryFilmCards = (filmCards) => {
  return filmCards.filter((filmCard) => filmCard.isAlreadyWatched);
};

const getFavoritesFilmCards = (filmCards) => {
  return filmCards.filter((filmCard) => filmCard.isFavorite);
};


const getCardsByFilter = (filmCards, filterType) => {
  switch (filterType) {
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: getWatchedMovies, getRangUser, getWatchedMoviesLength, getGenreOnWatchedMovies, getGenreData, getTopGenre, getPeriodCards */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWatchedMovies", function() { return getWatchedMovies; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRangUser", function() { return getRangUser; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWatchedMoviesLength", function() { return getWatchedMoviesLength; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getGenreOnWatchedMovies", function() { return getGenreOnWatchedMovies; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPeriodCards", function() { return getPeriodCards; });
/* harmony import */ var _utils_const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/const.js */ "./src/utils/const.js");
...
const getRangUser = (filmCards) => {
  ...
  if (watchedMovies <= _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["RangMapWatchedMovies"].NO_RANG) {
    return _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["RangMap"].NO_RANG;
  }
  if (watchedMovies <= _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["RangMapWatchedMovies"].NOVICE) {
    return _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["RangMap"].NOVICE;
  }
  if (watchedMovies >= _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["RangMapWatchedMovies"].NOVICE && watchedMovies <= _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["RangMapWatchedMovies"].FAN) {
    return _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["RangMap"].FAN;
  }
  if (watchedMovies >= _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["RangMapWatchedMovies"].MOVIE_BUFF) {
    return _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["RangMap"].MOVIE_BUFF;
  }
  return undefined;
};
...
const getWatchedMoviesLength = (filmCards, option) => {
  ...
  let minutes = 0;
  for (let i = 0; i < value; i++) {
    if (value >= _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["VALUE_HOUR"]) {
      hours++;
      value -= _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["VALUE_HOUR"];
    } else {
      minutes = value;
      break;
    }
...
const getGenreData = (filmCards) => {
  const genreData = {
    SCI_FI: getGenreOnWatchedMovies(filmCards, _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["GenreMap"].SCI_FI).length,
    ANIMATION: getGenreOnWatchedMovies(filmCards, _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["GenreMap"].ANIMATION).length,
    FANTASY: getGenreOnWatchedMovies(filmCards, _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["GenreMap"].FANTASY).length,
    COMEDY: getGenreOnWatchedMovies(filmCards, _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["GenreMap"].COMEDY).length,
    TV_SERIES: getGenreOnWatchedMovies(filmCards, _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["GenreMap"].TV_SERIES).length
  };
  return genreData;
};
...
const getTopGenre = (filmCards) => {
  ...
  return _utils_const_js__WEBPACK_IMPORTED_MODULE_0__["GenreMap"][maxValue];
};

const getPeriodCards = (filmCards, from, to) => {
  const watchedMovies = getWatchedMovies(filmCards);
  const periodCards = [];
  watchedMovies.forEach((filmCard) => {
